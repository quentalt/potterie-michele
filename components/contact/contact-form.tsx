        ...
        <section className="px-6 py-14">
            <div className="mx-auto max-w-4xl">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10">
                    ...
                    {/* Left: Map */}
                    <div className="relative overflow-hidden rounded-sm border border-border" style={{ minHeight: "320px" }}>
                        <iframe
                            width="100%"
                            height="500px"
                            frameBorder="0"
                    ...
                    {/* Right: orange header bar + form fields */}
                    <div className="rounded-sm border border-border p-6">
                    {/* Orange full-width header */}
                        ...
                        <form className="space-y-3 p-6">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full resize-none rounded-sm border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                            />
                            ...
                            <label className="flex cursor-pointer items-start gap-2">
                                ...
                                <span className="text-[11px] leading-relaxed text-muted-foreground">
                                    J'accepte les conditions générales fournies par
                                    l'entreprise. En fournissant mon numéro de téléphone,
                                    j'accepte de recevoir des messages textuels de la part
                                    de l'entreprise.
                                </span>
                            </label>
